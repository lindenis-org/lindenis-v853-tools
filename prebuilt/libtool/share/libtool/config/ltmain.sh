...
if test -n "$STAGING_DIR_HOST"; then
	...
	: ${EGREP="_REPLACE_HOST_BUILD_DIR_/out/host/bin/grep -E"}
	: ${FGREP="_REPLACE_HOST_BUILD_DIR_/out/host/bin/grep -F"}
	: ${GREP="_REPLACE_HOST_BUILD_DIR_/out/host/bin/grep"}
	: ${SED="_REPLACE_HOST_BUILD_DIR_/out/host/bin/sed"}
fi
